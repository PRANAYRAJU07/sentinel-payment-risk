...
# Convenience exports for tests and validators
KAGGLE_HANDLE = ACTIVE_DATASET.kaggle_handle
EXPECTED_TARGET_COLUMN = TARGET_COLUMN
EXPECTED_COLUMN_COUNT = len(ALL_FEATURE_COLUMNS) + 2  # features + Time + Class = 31
